# ROS-Sa2VA (RIS-LAD + RRSIS-D) full training config
...
# Per-device settings. If you use multiple GPUs, effective global batch is
# batch_size * accumulative_counts * world_size.
batch_size = 2
...
# RIS-LAD has fewer samples than RRSIS-D, so we upweight RIS-LAD.
# Effective sampling ratio here is approximately RIS-LAD:RRSIS-D = 2:1.
