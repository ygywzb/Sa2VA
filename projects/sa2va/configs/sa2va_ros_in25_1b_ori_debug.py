# only for debug
# ROS-Sa2VA (RIS-LAD + RRSIS-D) minimal debug config
...
# Make this config very small for smoke validation.
batch_size = 1
...
# repeats are set for a short read-check run (dozens of iterations),
# then training stops automatically after one epoch.
