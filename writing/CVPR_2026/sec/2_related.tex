...
Recent works explore this direction from image grounding, grounded visual chat, region captioning, and referring segmentation perspectives, including LISA~\cite{lai2023lisa}, Osprey~\cite{yuan2024osprey}, LLaVA-Grounding~\cite{zhang2023llavagrounding}, GLaMM~\cite{rasheed2024glamm}, F-LMM~\cite{wu2024flmm}, PixelLM~\cite{ren2023pixellm}, GSVA~\cite{xia2023gsva}, GroundHog~\cite{zhang2024groundhog}, PSALM~\cite{zhang2024psalm}, OMG-LLaVA~\cite{zhang2024omgllava}, VideoLISA~\cite{bai2024videolisa}, HyperSeg~\cite{wei2024hyperseg}, and VISA~\cite{yan2024visa}.
...
Earlier approaches often rely on heuristic pruning, attention-based early pruning, fixed downsampling, token merging, or architecture-specific compression rules~\cite{bolya2022tome,chen2024fastv,yang2024visionzip,zhang2024sparsevlm,zhu2024focusllava,yao2024deco}.
