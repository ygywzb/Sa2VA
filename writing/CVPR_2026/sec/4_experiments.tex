...
For image referring segmentation, we report cIoU on RefCOCO, RefCOCO+, and RefCOCOg~\cite{yu2016modeling}.
For video referring segmentation, we report J\&F on MeViS~\cite{ding2023mevis}, Ref-DAVIS17, ReVOS, and Ref-YTVOS; MeViS (val\_u) is also used in efficiency analysis.
