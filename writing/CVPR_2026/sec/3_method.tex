...
We present Sa2VA-Dev, which equips Sa2VA with a learnable visual token selector to retain features that best support \texttt{[SEG]} generation---the intermediate \emph{segmentability cues} consumed by SAM2.
